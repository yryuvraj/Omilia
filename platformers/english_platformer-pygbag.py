...
class EnglishPlatformer(Platformer):
    ...
    def load_fx(self) -> LanguageFx:
        return LanguageFx(
            pygame.mixer.Sound("English/img/martySpeech.ogg"),
            pygame.mixer.Sound("English/img/coin.ogg"),
            pygame.mixer.Sound("English/img/jump.ogg"),
            pygame.mixer.Sound("English/img/game_over.ogg"),
            "English/img/music.ogg",
            pygame.mixer.Sound("English/img/optionsound.ogg"),
            pygame.mixer.Sound("English/img/rightans.ogg"),
            pygame.mixer.Sound("English/img/wrongans.ogg"),
            "English/img/questionbg.ogg",
        )
